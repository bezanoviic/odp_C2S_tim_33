      ...
      <div style={{ position:"relative", zIndex:1, maxWidth:"900px", margin:"0 auto", padding:"56px 32px 60px" }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-end", marginBottom:"40px" }}>
          ...
          <button
            ...
            style={{ padding:"12px 22px", background: showForm ? "rgba(255,255,255,0.04)" : "rgba(78,231,255,0.08)", border:`1px solid ${showForm ? "rgba(255,255,255,0.1)" : "rgba(78,231,255,0.4)"}`, color: showForm ? "rgba(255,255,255,0.5)" : ACCENT, fontSize:"11px", fontWeight:700, letterSpacing:"0.18em", cursor:"pointer", fontFamily:"inherit" }}
          >
            {showForm ? "CANCEL" : "+ ADD GAME"}
          </button>
        </div>

        <div style={{ height:"1px", background:"rgba(78,231,255,0.15)", marginBottom:"32px" }} />

        {showForm && (
          <div style={{ background:"rgba(255,255,255,0.02)", border:"1px solid rgba(78,231,255,0.2)", padding:"28px 28px 20px", marginBottom:"32px", position:"relative" }}>
            <span style={{ position:"absolute", top:0, right:0, width:"8px", height:"8px", borderTop:"1px solid rgba(78,231,255,0.5)", borderRight:"1px solid rgba(78,231,255,0.5)" }} />
            <span style={{ position:"absolute", bottom:0, left:0, width:"8px", height:"8px", borderBottom:"1px solid rgba(78,231,255,0.5)", borderLeft:"1px solid rgba(78,231,255,0.5)" }} />
            ...
            <form onSubmit={handleSubmit}>
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:"0 32px" }}>
                <Field label="GAME NAME">
                  <input style={inputStyle} type="text" placeholder="e.g. Valorant" value={form.name}
                    ...
                    onFocus={e => e.target.style.borderBottomColor = "rgba(78,231,255,0.8)"}
              ...
              <button type="submit"
                style={{ width:"100%", padding:"14px", background:"rgba(78,231,255,0.08)", border:"1px solid rgba(78,231,255,0.4)", color:ACCENT, fontSize:"11px", fontWeight:700, letterSpacing:"0.22em", cursor:"pointer", fontFamily:"inherit", marginTop:"8px" }}
                onMouseEnter={e => { e.currentTarget.style.background="rgba(78,231,255,0.18)"; }}
                onMouseLeave={e => { e.currentTarget.style.background="rgba(78,231,255,0.08)"; }}>
          ...
          {games.map((game, idx) => (
            ...
            <div
              ...
              <div style={{ display:"flex", alignItems:"center", gap:"16px" }}>
                <span style={{ fontFamily:"monospace", fontSize:"11px", color:"rgba(78,231,255,0.4)", minWidth:"28px" }}>{String(idx + 1).padStart(2, "0")}</span>
              ...
              <div style={{ display:"flex", gap:"16px" }}>
                ...
                <button onClick={(e) => { e.stopPropagation(); handleDelete(game.id); }} style={{ fontSize:"11px", letterSpacing:"0.1em", color:"rgba(78,231,255,0.5)", background:"none", border:"none", cursor:"pointer", padding:0, fontFamily:"inherit" }}
                  onMouseEnter={e => e.currentTarget.style.color=ACCENT} onMouseLeave={e => e.currentTarget.style.color="rgba(78,231,255,0.5)"}>DELETE</button>
              </div>
            </div>
